    ...
    <div class="min-h-screen bg-[#f8fafc] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div class="w-full max-w-md premium-glass-card rounded-3xl p-8 border border-slate-200/80 relative overflow-hidden z-10">
        ...
        <div class="relative z-10 space-y-6">
          ...
          <!-- Loading state -->
          <div *ngIf="isLoading()" class="space-y-4 py-8 text-center flex flex-col items-center">
          ...
          <!-- Error state -->
          <div *ngIf="errorMsg() && !isLoading()" class="space-y-6 text-center">
          ...
          <div *ngIf="isCancelled() && !isLoading()" class="space-y-6 text-center">
